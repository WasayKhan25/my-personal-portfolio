...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "wasayalikhan.b@gmail.com",
    href: "mailto:wasayalikhan.b@gmail.com",
  },
  {
    icon: Github,
    label: "Github",
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                Whether you need a frontend engineer or a freelancer, let's talk!
              </p>
            </div>
          </div>
        </div>
